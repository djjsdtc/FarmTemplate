<%@ Page Title="好友农场" Language="C#" MasterPageFile="~/Farm/MasterPage.master" AutoEventWireup="true" CodeFile="FriendFarm.aspx.cs" Inherits="Farm_FriendFarm" %>
                                ...
                                <table style="width: 97%">
                                    <tr>
                                        ...
                                        <td class="auto-style11" rowspan="3">
                                            ...
                                            <asp:Button ID="Button1" runat="server" Text="摘取" OnClick="Button1_Click" />
                                        </td>
                                    </tr>
                                    <tr>
